...
def create_input_files(args, H_dataset_path,C_dataset_path, config_output_name,  img_size, dataset_size=4000000):
    '''
...
def main(args):
    ...
    val_loader = DataLoader(val_data, batch_size=args.batch_size, shuffle=False, pin_memory=True, drop_last=True)
