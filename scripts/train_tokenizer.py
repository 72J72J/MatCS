...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_files', type=str, default='your training files', help='source of input smiles data')
    ...
    parser.add_argument('--tokenizer_name', type=str, default='tokenizer_vocab_200.json')
    parser.add_argument('--vocab_size', type=int, default=200, help='Size of the vocab to rain')
